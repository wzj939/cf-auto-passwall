...
# 2、请更改 420 行 的 xxxxxxxxxx 字符串，为你自己 PassWall 的节点config nodes值（多个节点设置每行一个）

# 3、PassWall 的config nodes值请查看/etc/config/passwall
...
green "=========================================================="
 ...
 blue "资料网站： www.v2rayssr.com （已开启禁止国内访问）"
green "=========================================================="
green "=========================================================="
 red  "请在脚本中修改你期望优选 IP 的带宽大小（默认50M）脚本自动运行中....."
 red  "脚本第41行 bandwidth 后面的数值为期望优选带宽大小（ Mbps ）  "
green "=================脚本正在运行中.....======================="
sleep 8s
